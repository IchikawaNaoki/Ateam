...
<!-- jQuery -->
	...
	<c:out value="${loginStatus.status}"/>中
	<c:out value="${getDb.belong}"/>ですの
<!--
	<c:choose>

		<c:when test="${loginStatus.status == \"在席\"}">
			<p>在席中</p>
		</c:when>
...
-->
	...
	<form action="/aTeam/Main" method="post" name="fourth">
	<li><input type=hidden name=sapporo value="札幌">
	<a href="javascript:fourth.submit()">札幌</a></li>
	</form>
	</ul>
	</li>
